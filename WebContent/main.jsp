...
<body>
   ...
   <header id="main-header">
      ...
      <nav class="header_inner">
         ...
         <div class="header_menu">
            ...
            <div class="logo">
               <a href="main.html"> <img src="images/logo3.png" width="280"
                  alt="Logo" id="logo">
               </a>
            </div>
   ...
   <div id="main">
      ...
      <div id="image">
         ...
         <div class="work">
            ...
            <a href="#"><div class="work_text">산책모임 바로가기</div></a>
         </div>
      </div>
      ...
      <div id="diary">
         ...
         <img src="images/Diary.jpg"
            style="border: 0.6px solid #44704D; border-radius: 10px; margin-top: 30px; float: left;">
         </div>
   ...
   <div id="footer">
      <div class="footer_inner">
         <div class="copyright">
            <img src="images/logo3.png" width="250" style="float: left;"><br>
            <br>
